...
contract Penyelenggara is AccessControl {
    ...
    function setAdminPetugasAddress(address _adminPetugasAddress) internal onlyOwner {
    ...
    function removeAdminPetugasAddress(address _adminPetugasAddress) internal onlyOwner {
    ...
    function addNewPetugas(address _petugasAddress) internal onlyAdminPetugas {
        grantRole(DEFAULT_ROLE_PETUGAS, _petugasAddress);
        emit RoleGranted(DEFAULT_ROLE_PETUGAS, _petugasAddress, msg.sender);
    }
    
    function removePetugas(address _petugasAddress) internal onlyAdminPetugas {
